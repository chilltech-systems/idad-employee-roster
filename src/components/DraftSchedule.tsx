...
export default function DraftSchedule({
  ...
  return (
    <section className="panel card">
      <h2>Texas Schedule connection</h2>
      <p>
        Managers continue scheduling in column N and the existing daily time
        cells.
      </p>
      <a
        className="text-link"
        href="https://docs.google.com/spreadsheets/d/1CYTmBf6hWkiwcyqt6LRjNrekJD4FmMTN25d4Pkr4B0o/edit#gid=1883086419"
        target="_blank"
        rel="noreferrer"
      >
      ...
      <p>
        The date comes from Texas Schedule P1. Every populated mapped shift is
        validated. Errors leave the previous accepted export intact.
      </p>
      <label>
        ...
        />
        <small>
          One schedule row and reason per line. Excluded shifts remain listed in
          the export; they are not a complete store snapshot.
        </small>
      </label>
      <label>
        ...
        />
        <small>
          One row:day per line, with Sunday = 0 through Saturday = 6. Use only
          when the shift ends the next day.
        </small>
      </label>
      <button
        className="primary"
      ...
      {result && (
        <div>
          ...
          <p className="muted">
            Private schedule draft export. Live schedules and labor reports have
            not been updated.
          </p>
        </div>
      )}
